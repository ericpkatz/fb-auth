...
app.get('/facebook/login/callback', (req, res, next)=> {
  ...
  const url = `https://graph.facebook.com/v3.0/oauth/access_token?client_id=${FACEBOOK_APP_ID}&redirect_uri=https://ek-fb-testing.herokuapp.com/facebook/login/callback&client_secret=${FACEBOOK_SECRET_ID}&code=${code}`
